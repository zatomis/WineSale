...
excel_value = pandas.read_excel('wine3.xlsx', sheet_name='Лист1', usecols=['Категория', 'Название', 'Сорт', 'Цена', 'Картинка', 'Акция'])
...
rendered_page = template.render(wines=products_by_category, count_year=f"{datetime.date.today().year - START_YEAR}  {correct_year(datetime.date.today().year - START_YEAR)}")
